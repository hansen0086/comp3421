"""
    ...
    http://www.cse.unsw.edu.au/~cs3421/16s2/lectures/ to the current directory
...
if __name__ == "__main__":
    url = "http://www.cse.unsw.edu.au/~cs3421/16s2/lectures/"
    r = requests.get(url)
    ...
    while 1:
        ...
        if matchObj:
            ...
            download_url = "http://www.cse.unsw.edu.au/~cs3421/16s2/lectures/"+matchObj.group(2)+".pdf"
